...
OUT_VEC_FILE = Path("results/vectors_hotspots.pt")
...
for layer_idx in target_layers:
    print(f"[*] Verarbeite Hotspot-Schicht {layer_idx}...")
    acts_refuse = []
    acts_action = []
...
torch.save({"layers": target_layers, "vectors": vectors}, OUT_VEC_FILE)
print(f"[OK] Hotspot-Vektoren gespeichert in {OUT_VEC_FILE}")
